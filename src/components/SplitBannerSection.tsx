...
export const SplitBannerSection = ({ items }: Readonly<SplitBannerSectionProps>) => {
  return (
    <div className="w-full pt-6 md:pt-0 bg-gray-50">
            ...
            >
              ...
              <div className="absolute inset-0 flex flex-col justify-end p-6 md:p-10 text-white z-10">
                ...
                <a
                  ...
                  className="mt-6 inline-block w-fit px-8 py-3 text-sm font-semibold text-white bg-accent-600 hover:bg-accent-700 rounded-full transition-colors"
                >
                  {item.buttonText}
                </a>
              </div>
