          ...
          <div className="relative h-full flex flex-col justify-end p-4 sm:p-6 lg:p-8">
            <div className="max-w-md">
              ...
              <a
                ...
                className="inline-block bg-accent-600 hover:bg-accent-700 text-white font-semibold py-2 px-4 sm:py-3 sm:px-6 rounded-lg text-xs sm:text-sm lg:text-base uppercase tracking-wide transition-colors duration-200 shadow-lg"
              >
                {section.buttonText}
              </a>
            </div>
